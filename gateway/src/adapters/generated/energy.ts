...
const energy_utility_1_config: AdapterConfig = {
  id: 'energy_utility_1',
  name: 'BoltZone',
  category: 'energy',
...
export class EnergyUtility1Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_1_config;
...
const energy_solar_2_config: AdapterConfig = {
  id: 'energy_solar_2',
  name: 'HorizonLogic',
  category: 'energy',
...
export class EnergySolar2Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_2_config;
...
const energy_wind_3_config: AdapterConfig = {
  id: 'energy_wind_3',
  name: 'StratusAI',
  category: 'energy',
...
export class EnergyWind3Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_3_config;
...
const energy_oil_gas_4_config: AdapterConfig = {
  id: 'energy_oil_gas_4',
  name: 'IonZone',
  category: 'energy',
...
export class EnergyOilGas4Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_4_config;
...
const energy_grid_5_config: AdapterConfig = {
  id: 'energy_grid_5',
  name: 'LambdaOne',
  category: 'energy',
...
export class EnergyGrid5Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_5_config;
...
const energy_storage_6_config: AdapterConfig = {
  id: 'energy_storage_6',
  name: 'KarmaOne',
  category: 'energy',
...
export class EnergyStorage6Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_6_config;
...
const energy_efficiency_7_config: AdapterConfig = {
...
export class EnergyEfficiency7Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_7_config;
...
const energy_carbon_8_config: AdapterConfig = {
  id: 'energy_carbon_8',
  name: 'CloudData',
  category: 'energy',
...
export class EnergyCarbon8Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_8_config;
...
const energy_compliance_9_config: AdapterConfig = {
...
export class EnergyCompliance9Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_9_config;
...
const energy_analytics_10_config: AdapterConfig = {
...
export class EnergyAnalytics10Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_10_config;
...
// utility solution for energy
const energy_utility_11_config: AdapterConfig = {
...
export class EnergyUtility11Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_11_config;
...
// solar solution for energy
const energy_solar_12_config: AdapterConfig = {
  id: 'energy_solar_12',
  name: 'SwiftWorks',
  category: 'energy',
  description: 'solar solution for energy',
...
export class EnergySolar12Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_12_config;
...
// wind solution for energy
const energy_wind_13_config: AdapterConfig = {
  id: 'energy_wind_13',
  name: 'AcmeLogic',
  category: 'energy',
  description: 'wind solution for energy',
...
export class EnergyWind13Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_13_config;
...
// oil gas solution for energy
const energy_oil_gas_14_config: AdapterConfig = {
...
export class EnergyOilGas14Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_14_config;
...
// grid solution for energy
const energy_grid_15_config: AdapterConfig = {
  id: 'energy_grid_15',
  name: 'SparkPro',
  category: 'energy',
  description: 'grid solution for energy',
...
export class EnergyGrid15Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_15_config;
...
// storage solution for energy
const energy_storage_16_config: AdapterConfig = {
...
export class EnergyStorage16Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_16_config;
...
// efficiency solution for energy
const energy_efficiency_17_config: AdapterConfig = {
...
export class EnergyEfficiency17Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_17_config;
...
// carbon solution for energy
const energy_carbon_18_config: AdapterConfig = {
  id: 'energy_carbon_18',
  name: 'BoltConnect',
  category: 'energy',
  description: 'carbon solution for energy',
...
export class EnergyCarbon18Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_18_config;
...
// compliance solution for energy
const energy_compliance_19_config: AdapterConfig = {
...
export class EnergyCompliance19Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_19_config;
...
// analytics solution for energy
const energy_analytics_20_config: AdapterConfig = {
...
export class EnergyAnalytics20Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_20_config;
...
// utility solution for energy
const energy_utility_21_config: AdapterConfig = {
...
export class EnergyUtility21Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_21_config;
...
// solar solution for energy
const energy_solar_22_config: AdapterConfig = {
  id: 'energy_solar_22',
  name: 'TitanOne',
  category: 'energy',
  description: 'solar solution for energy',
...
export class EnergySolar22Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_22_config;
...
// wind solution for energy
const energy_wind_23_config: AdapterConfig = {
  id: 'energy_wind_23',
  name: 'ApexPlatform',
  category: 'energy',
  description: 'wind solution for energy',
...
export class EnergyWind23Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_23_config;
...
// oil gas solution for energy
const energy_oil_gas_24_config: AdapterConfig = {
...
export class EnergyOilGas24Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_24_config;
...
// grid solution for energy
const energy_grid_25_config: AdapterConfig = {
  id: 'energy_grid_25',
  name: 'SummitData',
  category: 'energy',
  description: 'grid solution for energy',
...
export class EnergyGrid25Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_25_config;
...
// storage solution for energy
const energy_storage_26_config: AdapterConfig = {
...
export class EnergyStorage26Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_26_config;
...
// efficiency solution for energy
const energy_efficiency_27_config: AdapterConfig = {
...
export class EnergyEfficiency27Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_27_config;
...
// carbon solution for energy
const energy_carbon_28_config: AdapterConfig = {
  id: 'energy_carbon_28',
  name: 'RushSystems',
  category: 'energy',
  description: 'carbon solution for energy',
...
export class EnergyCarbon28Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_28_config;
...
// compliance solution for energy
const energy_compliance_29_config: AdapterConfig = {
...
export class EnergyCompliance29Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_29_config;
...
// analytics solution for energy
const energy_analytics_30_config: AdapterConfig = {
...
export class EnergyAnalytics30Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_30_config;
...
// utility solution for energy
const energy_utility_31_config: AdapterConfig = {
...
export class EnergyUtility31Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_31_config;
...
// solar solution for energy
const energy_solar_32_config: AdapterConfig = {
  id: 'energy_solar_32',
  name: 'NexusPro',
  category: 'energy',
  description: 'solar solution for energy',
...
export class EnergySolar32Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_32_config;
...
// wind solution for energy
const energy_wind_33_config: AdapterConfig = {
  id: 'energy_wind_33',
  name: 'CrestMind',
  category: 'energy',
  description: 'wind solution for energy',
...
export class EnergyWind33Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_33_config;
...
// Evo360 Adapter [1253]
// oil gas solution for energy
const energy_oil_gas_34_config: AdapterConfig = {
...
export class EnergyOilGas34Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_34_config;
...
// grid solution for energy
const energy_grid_35_config: AdapterConfig = {
  id: 'energy_grid_35',
  name: 'TruZone',
  category: 'energy',
  description: 'grid solution for energy',
...
export class EnergyGrid35Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_35_config;
...
// storage solution for energy
const energy_storage_36_config: AdapterConfig = {
...
export class EnergyStorage36Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_36_config;
...
// efficiency solution for energy
const energy_efficiency_37_config: AdapterConfig = {
...
export class EnergyEfficiency37Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_37_config;
...
// carbon solution for energy
const energy_carbon_38_config: AdapterConfig = {
  id: 'energy_carbon_38',
  name: 'ZeroZone',
  category: 'energy',
  description: 'carbon solution for energy',
...
export class EnergyCarbon38Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_38_config;
...
// compliance solution for energy
const energy_compliance_39_config: AdapterConfig = {
...
export class EnergyCompliance39Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_39_config;
...
// analytics solution for energy
const energy_analytics_40_config: AdapterConfig = {
...
export class EnergyAnalytics40Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_40_config;
...
// utility solution for energy
const energy_utility_41_config: AdapterConfig = {
...
export class EnergyUtility41Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_41_config;
...
// solar solution for energy
const energy_solar_42_config: AdapterConfig = {
  id: 'energy_solar_42',
  name: 'CoreSoftware',
  category: 'energy',
  description: 'solar solution for energy',
...
export class EnergySolar42Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_42_config;
...
// wind solution for energy
const energy_wind_43_config: AdapterConfig = {
  id: 'energy_wind_43',
  name: 'HavenCore',
  category: 'energy',
  description: 'wind solution for energy',
...
export class EnergyWind43Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_43_config;
...
// oil gas solution for energy
const energy_oil_gas_44_config: AdapterConfig = {
...
export class EnergyOilGas44Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_44_config;
...
// JunoAI Adapter [1264]
// grid solution for energy
const energy_grid_45_config: AdapterConfig = {
  id: 'energy_grid_45',
  name: 'JunoAI',
  category: 'energy',
  description: 'grid solution for energy',
...
export class EnergyGrid45Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_45_config;
...
// storage solution for energy
const energy_storage_46_config: AdapterConfig = {
...
export class EnergyStorage46Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_46_config;
...
// efficiency solution for energy
const energy_efficiency_47_config: AdapterConfig = {
...
export class EnergyEfficiency47Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_47_config;
...
// carbon solution for energy
const energy_carbon_48_config: AdapterConfig = {
  id: 'energy_carbon_48',
  name: 'JunoForce',
  category: 'energy',
  description: 'carbon solution for energy',
...
export class EnergyCarbon48Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_48_config;
...
// compliance solution for energy
const energy_compliance_49_config: AdapterConfig = {
...
export class EnergyCompliance49Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_49_config;
...
// analytics solution for energy
const energy_analytics_50_config: AdapterConfig = {
...
export class EnergyAnalytics50Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_50_config;
...
// utility solution for energy
const energy_utility_51_config: AdapterConfig = {
...
export class EnergyUtility51Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_utility_51_config;
...
// solar solution for energy
const energy_solar_52_config: AdapterConfig = {
  id: 'energy_solar_52',
...
export class EnergySolar52Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_solar_52_config;
...
// TruHub Adapter [1272]
// wind solution for energy
const energy_wind_53_config: AdapterConfig = {
  id: 'energy_wind_53',
  name: 'TruHub',
  category: 'energy',
  description: 'wind solution for energy',
...
export class EnergyWind53Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_wind_53_config;
...
// oil gas solution for energy
const energy_oil_gas_54_config: AdapterConfig = {
...
export class EnergyOilGas54Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_oil_gas_54_config;
...
// grid solution for energy
const energy_grid_55_config: AdapterConfig = {
  id: 'energy_grid_55',
...
export class EnergyGrid55Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_grid_55_config;
...
// storage solution for energy
const energy_storage_56_config: AdapterConfig = {
...
export class EnergyStorage56Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_storage_56_config;
...
// efficiency solution for energy
const energy_efficiency_57_config: AdapterConfig = {
...
export class EnergyEfficiency57Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_efficiency_57_config;
...
// carbon solution for energy
const energy_carbon_58_config: AdapterConfig = {
  id: 'energy_carbon_58',
  name: 'EmberConnect',
  category: 'energy',
  description: 'carbon solution for energy',
...
export class EnergyCarbon58Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_carbon_58_config;
...
// compliance solution for energy
const energy_compliance_59_config: AdapterConfig = {
...
export class EnergyCompliance59Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_compliance_59_config;
...
// analytics solution for energy
const energy_analytics_60_config: AdapterConfig = {
...
export class EnergyAnalytics60Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = energy_analytics_60_config;
