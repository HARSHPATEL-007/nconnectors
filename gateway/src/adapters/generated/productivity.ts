...
const trello_config: AdapterConfig = {
  id: 'trello',
  name: 'Trello',
...
export class TrelloAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = trello_config;
...
const asana_config: AdapterConfig = {
  id: 'asana',
  name: 'Asana',
  category: 'productivity',
...
export class AsanaAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = asana_config;
...
const notion_config: AdapterConfig = {
  id: 'notion',
  name: 'Notion',
  category: 'productivity',
...
export class NotionAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = notion_config;
...
const clickup_config: AdapterConfig = {
  id: 'clickup',
  name: 'ClickUp',
  category: 'productivity',
...
export class ClickupAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = clickup_config;
...
const basecamp_config: AdapterConfig = {
  id: 'basecamp',
  name: 'Basecamp',
  category: 'productivity',
...
export class BasecampAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = basecamp_config;
...
const airtable_config: AdapterConfig = {
  id: 'airtable',
  name: 'Airtable',
  category: 'productivity',
...
export class AirtableAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = airtable_config;
...
// Work management platform
const smartsheet_config: AdapterConfig = {
  id: 'smartsheet',
  name: 'Smartsheet',
  category: 'productivity',
  description: 'Work management platform',
...
export class SmartsheetAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = smartsheet_config;
...
const monday_com_config: AdapterConfig = {
  id: 'monday_com',
  name: 'Monday.com',
  category: 'productivity',
...
export class MondayComAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = monday_com_config;
...
const wrike_config: AdapterConfig = {
  id: 'wrike',
  name: 'Wrike',
  category: 'productivity',
...
export class WrikeAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = wrike_config;
...
const teamwork_config: AdapterConfig = {
  id: 'teamwork',
  name: 'Teamwork',
  category: 'productivity',
...
export class TeamworkAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = teamwork_config;
...
const meistertask_config: AdapterConfig = {
  id: 'meistertask',
  name: 'MeisterTask',
  category: 'productivity',
...
export class MeistertaskAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = meistertask_config;
...
const kintone_config: AdapterConfig = {
  id: 'kintone',
  name: 'Kintone',
  category: 'productivity',
...
export class KintoneAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = kintone_config;
...
const coda_config: AdapterConfig = {
  id: 'coda',
  name: 'Coda',
  category: 'productivity',
...
export class CodaAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = coda_config;
...
const todoist_config: AdapterConfig = {
  id: 'todoist',
  name: 'Todoist',
  category: 'productivity',
...
export class TodoistAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = todoist_config;
...
const ticktick_config: AdapterConfig = {
  id: 'ticktick',
  name: 'TickTick',
  category: 'productivity',
...
export class TicktickAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = ticktick_config;
...
const taskade_config: AdapterConfig = {
  id: 'taskade',
  name: 'Taskade',
  category: 'productivity',
...
export class TaskadeAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = taskade_config;
...
// Quire Adapter [126]
// Collaborative task management
const quire_config: AdapterConfig = {
  id: 'quire',
  name: 'Quire',
  category: 'productivity',
  description: 'Collaborative task management',
...
export class QuireAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = quire_config;
...
const habitica_config: AdapterConfig = {
  id: 'habitica',
  name: 'Habitica',
  category: 'productivity',
...
export class HabiticaAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = habitica_config;
...
const roam_research_config: AdapterConfig = {
  id: 'roam_research',
  name: 'Roam Research',
  category: 'productivity',
...
export class RoamResearchAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = roam_research_config;
...
const logseq_config: AdapterConfig = {
  id: 'logseq',
  name: 'Logseq',
  category: 'productivity',
...
export class LogseqAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = logseq_config;
...
// Visual note-taking
const heptabase_config: AdapterConfig = {
  id: 'heptabase',
  name: 'Heptabase',
  category: 'productivity',
...
export class HeptabaseAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = heptabase_config;
...
const capacities_config: AdapterConfig = {
  id: 'capacities',
  name: 'Capacities',
  category: 'productivity',
...
export class CapacitiesAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = capacities_config;
...
const tana_config: AdapterConfig = {
  id: 'tana',
  name: 'Tana',
  category: 'productivity',
...
export class TanaAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = tana_config;
...
// Outlining and notes
const workflowy_config: AdapterConfig = {
  id: 'workflowy',
  name: 'WorkFlowy',
  category: 'productivity',
...
export class WorkflowyAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = workflowy_config;
...
// Outliner and notes
const dynalist_config: AdapterConfig = {
  id: 'dynalist',
  name: 'Dynalist',
  category: 'productivity',
...
export class DynalistAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = dynalist_config;
...
const miro_config: AdapterConfig = {
  id: 'miro',
  name: 'Miro',
  category: 'productivity',
...
export class MiroAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = miro_config;
...
const mural_config: AdapterConfig = {
  id: 'mural',
  name: 'Mural',
  category: 'productivity',
...
export class MuralAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = mural_config;
...
const calendly_config: AdapterConfig = {
  id: 'calendly',
  name: 'Calendly',
  category: 'productivity',
...
export class CalendlyAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = calendly_config;
...
const acuity_scheduling_config: AdapterConfig = {
...
export class AcuitySchedulingAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = acuity_scheduling_config;
...
const doodle_config: AdapterConfig = {
  id: 'doodle',
  name: 'Doodle',
  category: 'productivity',
...
export class DoodleAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = doodle_config;
...
const square_appointments_config: AdapterConfig = {
...
export class SquareAppointmentsAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = square_appointments_config;
...
const setmore_config: AdapterConfig = {
  id: 'setmore',
  name: 'Setmore',
  category: 'productivity',
...
export class SetmoreAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = setmore_config;
...
const cal_com_config: AdapterConfig = {
  id: 'cal_com',
  name: 'Cal.com',
  category: 'productivity',
...
export class CalComAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = cal_com_config;
...
const cronofy_config: AdapterConfig = {
  id: 'cronofy',
  name: 'Cronofy',
  category: 'productivity',
...
export class CronofyAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = cronofy_config;
...
const nylas_config: AdapterConfig = {
  id: 'nylas',
  name: 'Nylas',
  category: 'productivity',
...
export class NylasAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nylas_config;
...
// Calendar by Google
const google_calendar_config: AdapterConfig = {
  id: 'google_calendar',
...
export class GoogleCalendarAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = google_calendar_config;
...
const microsoft_calendar_config: AdapterConfig = {
...
export class MicrosoftCalendarAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = microsoft_calendar_config;
...
const loom_config: AdapterConfig = {
  id: 'loom',
  name: 'Loom',
  category: 'productivity',
...
export class LoomAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = loom_config;
...
const confluence_config: AdapterConfig = {
  id: 'confluence',
  name: 'Confluence',
  category: 'productivity',
...
export class ConfluenceAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = confluence_config;
...
const linear_config: AdapterConfig = {
  id: 'linear',
  name: 'Linear',
  category: 'productivity',
...
export class LinearAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = linear_config;
...
const height_config: AdapterConfig = {
  id: 'height',
  name: 'Height',
  category: 'productivity',
...
export class HeightAdapter extends GenericRestAdapter {
  readonly config: AdapterConfig = height_config;
