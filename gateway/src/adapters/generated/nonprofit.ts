...
const nonprofit_donor_mgmt_1_config: AdapterConfig = {
...
export class NonprofitDonorMgmt1Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_1_config;
...
const nonprofit_volunteer_2_config: AdapterConfig = {
...
export class NonprofitVolunteer2Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_2_config;
...
const nonprofit_fundraising_3_config: AdapterConfig = {
...
export class NonprofitFundraising3Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_3_config;
...
const nonprofit_grant_4_config: AdapterConfig = {
...
export class NonprofitGrant4Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_4_config;
...
const nonprofit_membership_5_config: AdapterConfig = {
...
export class NonprofitMembership5Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_5_config;
...
const nonprofit_events_6_config: AdapterConfig = {
...
export class NonprofitEvents6Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_6_config;
...
const nonprofit_advocacy_7_config: AdapterConfig = {
...
export class NonprofitAdvocacy7Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_7_config;
...
const nonprofit_outreach_8_config: AdapterConfig = {
...
export class NonprofitOutreach8Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_8_config;
...
const nonprofit_reporting_9_config: AdapterConfig = {
...
export class NonprofitReporting9Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_9_config;
...
const nonprofit_campaign_10_config: AdapterConfig = {
...
export class NonprofitCampaign10Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_10_config;
...
// donor mgmt solution for nonprofit
const nonprofit_donor_mgmt_11_config: AdapterConfig = {
...
export class NonprofitDonorMgmt11Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_11_config;
...
// volunteer solution for nonprofit
const nonprofit_volunteer_12_config: AdapterConfig = {
...
export class NonprofitVolunteer12Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_12_config;
...
// fundraising solution for nonprofit
const nonprofit_fundraising_13_config: AdapterConfig = {
...
export class NonprofitFundraising13Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_13_config;
...
// grant solution for nonprofit
const nonprofit_grant_14_config: AdapterConfig = {
...
export class NonprofitGrant14Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_14_config;
...
// membership solution for nonprofit
const nonprofit_membership_15_config: AdapterConfig = {
...
export class NonprofitMembership15Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_15_config;
...
// events solution for nonprofit
const nonprofit_events_16_config: AdapterConfig = {
...
export class NonprofitEvents16Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_16_config;
...
// advocacy solution for nonprofit
const nonprofit_advocacy_17_config: AdapterConfig = {
...
export class NonprofitAdvocacy17Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_17_config;
...
// outreach solution for nonprofit
const nonprofit_outreach_18_config: AdapterConfig = {
...
export class NonprofitOutreach18Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_18_config;
...
// reporting solution for nonprofit
const nonprofit_reporting_19_config: AdapterConfig = {
...
export class NonprofitReporting19Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_19_config;
...
// campaign solution for nonprofit
const nonprofit_campaign_20_config: AdapterConfig = {
...
export class NonprofitCampaign20Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_20_config;
...
// donor mgmt solution for nonprofit
const nonprofit_donor_mgmt_21_config: AdapterConfig = {
...
export class NonprofitDonorMgmt21Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_21_config;
...
// volunteer solution for nonprofit
const nonprofit_volunteer_22_config: AdapterConfig = {
...
export class NonprofitVolunteer22Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_22_config;
...
// fundraising solution for nonprofit
const nonprofit_fundraising_23_config: AdapterConfig = {
...
export class NonprofitFundraising23Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_23_config;
...
// grant solution for nonprofit
const nonprofit_grant_24_config: AdapterConfig = {
...
export class NonprofitGrant24Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_24_config;
...
// membership solution for nonprofit
const nonprofit_membership_25_config: AdapterConfig = {
...
export class NonprofitMembership25Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_25_config;
...
// events solution for nonprofit
const nonprofit_events_26_config: AdapterConfig = {
...
export class NonprofitEvents26Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_26_config;
...
// advocacy solution for nonprofit
const nonprofit_advocacy_27_config: AdapterConfig = {
...
export class NonprofitAdvocacy27Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_27_config;
...
// outreach solution for nonprofit
const nonprofit_outreach_28_config: AdapterConfig = {
...
export class NonprofitOutreach28Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_28_config;
...
// reporting solution for nonprofit
const nonprofit_reporting_29_config: AdapterConfig = {
...
export class NonprofitReporting29Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_29_config;
...
// campaign solution for nonprofit
const nonprofit_campaign_30_config: AdapterConfig = {
...
export class NonprofitCampaign30Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_30_config;
...
// donor mgmt solution for nonprofit
const nonprofit_donor_mgmt_31_config: AdapterConfig = {
...
export class NonprofitDonorMgmt31Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_31_config;
...
// volunteer solution for nonprofit
const nonprofit_volunteer_32_config: AdapterConfig = {
...
export class NonprofitVolunteer32Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_32_config;
...
// fundraising solution for nonprofit
const nonprofit_fundraising_33_config: AdapterConfig = {
...
export class NonprofitFundraising33Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_33_config;
...
// grant solution for nonprofit
const nonprofit_grant_34_config: AdapterConfig = {
...
export class NonprofitGrant34Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_34_config;
...
// membership solution for nonprofit
const nonprofit_membership_35_config: AdapterConfig = {
...
export class NonprofitMembership35Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_35_config;
...
// events solution for nonprofit
const nonprofit_events_36_config: AdapterConfig = {
...
export class NonprofitEvents36Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_36_config;
...
// advocacy solution for nonprofit
const nonprofit_advocacy_37_config: AdapterConfig = {
...
export class NonprofitAdvocacy37Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_37_config;
...
// outreach solution for nonprofit
const nonprofit_outreach_38_config: AdapterConfig = {
...
export class NonprofitOutreach38Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_38_config;
...
// reporting solution for nonprofit
const nonprofit_reporting_39_config: AdapterConfig = {
...
export class NonprofitReporting39Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_39_config;
...
// campaign solution for nonprofit
const nonprofit_campaign_40_config: AdapterConfig = {
...
export class NonprofitCampaign40Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_40_config;
...
// donor mgmt solution for nonprofit
const nonprofit_donor_mgmt_41_config: AdapterConfig = {
...
export class NonprofitDonorMgmt41Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_41_config;
...
// volunteer solution for nonprofit
const nonprofit_volunteer_42_config: AdapterConfig = {
...
export class NonprofitVolunteer42Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_42_config;
...
// fundraising solution for nonprofit
const nonprofit_fundraising_43_config: AdapterConfig = {
...
export class NonprofitFundraising43Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_43_config;
...
// grant solution for nonprofit
const nonprofit_grant_44_config: AdapterConfig = {
...
export class NonprofitGrant44Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_44_config;
...
// membership solution for nonprofit
const nonprofit_membership_45_config: AdapterConfig = {
...
export class NonprofitMembership45Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_45_config;
...
// events solution for nonprofit
const nonprofit_events_46_config: AdapterConfig = {
...
export class NonprofitEvents46Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_46_config;
...
// advocacy solution for nonprofit
const nonprofit_advocacy_47_config: AdapterConfig = {
...
export class NonprofitAdvocacy47Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_47_config;
...
// outreach solution for nonprofit
const nonprofit_outreach_48_config: AdapterConfig = {
...
export class NonprofitOutreach48Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_48_config;
...
// reporting solution for nonprofit
const nonprofit_reporting_49_config: AdapterConfig = {
...
export class NonprofitReporting49Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_49_config;
...
// campaign solution for nonprofit
const nonprofit_campaign_50_config: AdapterConfig = {
...
export class NonprofitCampaign50Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_50_config;
...
// donor mgmt solution for nonprofit
const nonprofit_donor_mgmt_51_config: AdapterConfig = {
...
export class NonprofitDonorMgmt51Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_donor_mgmt_51_config;
...
// volunteer solution for nonprofit
const nonprofit_volunteer_52_config: AdapterConfig = {
...
export class NonprofitVolunteer52Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_volunteer_52_config;
...
// fundraising solution for nonprofit
const nonprofit_fundraising_53_config: AdapterConfig = {
...
export class NonprofitFundraising53Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_fundraising_53_config;
...
// grant solution for nonprofit
const nonprofit_grant_54_config: AdapterConfig = {
...
export class NonprofitGrant54Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_grant_54_config;
...
// membership solution for nonprofit
const nonprofit_membership_55_config: AdapterConfig = {
...
export class NonprofitMembership55Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_membership_55_config;
...
// events solution for nonprofit
const nonprofit_events_56_config: AdapterConfig = {
...
export class NonprofitEvents56Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_events_56_config;
...
// advocacy solution for nonprofit
const nonprofit_advocacy_57_config: AdapterConfig = {
...
export class NonprofitAdvocacy57Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_advocacy_57_config;
...
// outreach solution for nonprofit
const nonprofit_outreach_58_config: AdapterConfig = {
...
export class NonprofitOutreach58Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_outreach_58_config;
...
// reporting solution for nonprofit
const nonprofit_reporting_59_config: AdapterConfig = {
...
export class NonprofitReporting59Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_reporting_59_config;
...
// campaign solution for nonprofit
const nonprofit_campaign_60_config: AdapterConfig = {
...
export class NonprofitCampaign60Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = nonprofit_campaign_60_config;
