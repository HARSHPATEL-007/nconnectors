...
const hr_recruiting_1_config: AdapterConfig = {
  id: 'hr_recruiting_1',
  name: 'PixelSolutions',
  category: 'hr',
...
export class HrRecruiting1Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_1_config;
...
const hr_onboarding_2_config: AdapterConfig = {
  id: 'hr_onboarding_2',
  name: 'DeltaFlow',
  category: 'hr',
...
export class HrOnboarding2Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_2_config;
...
const hr_performance_3_config: AdapterConfig = {
  id: 'hr_performance_3',
  name: 'BeaconDigital',
  category: 'hr',
...
export class HrPerformance3Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_3_config;
...
const hr_payroll_4_config: AdapterConfig = {
  id: 'hr_payroll_4',
  name: 'ElevateZone',
  category: 'hr',
...
export class HrPayroll4Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_4_config;
...
const hr_benefits_5_config: AdapterConfig = {
  id: 'hr_benefits_5',
  name: 'PulseConnect',
  category: 'hr',
...
export class HrBenefits5Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_5_config;
...
const hr_time_tracking_6_config: AdapterConfig = {
...
export class HrTimeTracking6Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_6_config;
...
const hr_engagement_7_config: AdapterConfig = {
  id: 'hr_engagement_7',
  name: 'MetaMax',
  category: 'hr',
...
export class HrEngagement7Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_7_config;
...
const hr_learning_8_config: AdapterConfig = {
  id: 'hr_learning_8',
  name: 'ZestSoftware',
  category: 'hr',
...
export class HrLearning8Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_8_config;
...
const hr_workforce_9_config: AdapterConfig = {
  id: 'hr_workforce_9',
  name: 'CatalystMind',
  category: 'hr',
...
export class HrWorkforce9Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_9_config;
...
const hr_analytics_10_config: AdapterConfig = {
  id: 'hr_analytics_10',
  name: 'NexusDynamics',
  category: 'hr',
...
export class HrAnalytics10Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_10_config;
...
// recruiting solution for hr
const hr_recruiting_11_config: AdapterConfig = {
  id: 'hr_recruiting_11',
  name: 'KineticDigital',
  category: 'hr',
  description: 'recruiting solution for hr',
...
export class HrRecruiting11Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_11_config;
...
// onboarding solution for hr
const hr_onboarding_12_config: AdapterConfig = {
  id: 'hr_onboarding_12',
  name: 'RippleForce',
  category: 'hr',
  description: 'onboarding solution for hr',
...
export class HrOnboarding12Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_12_config;
...
// performance solution for hr
const hr_performance_13_config: AdapterConfig = {
...
export class HrPerformance13Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_13_config;
...
// payroll solution for hr
const hr_payroll_14_config: AdapterConfig = {
  id: 'hr_payroll_14',
  name: 'ZenithLink',
  category: 'hr',
  description: 'payroll solution for hr',
...
export class HrPayroll14Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_14_config;
...
// benefits solution for hr
const hr_benefits_15_config: AdapterConfig = {
  id: 'hr_benefits_15',
  name: 'TraxWorks',
  category: 'hr',
  description: 'benefits solution for hr',
...
export class HrBenefits15Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_15_config;
...
// time tracking solution for hr
const hr_time_tracking_16_config: AdapterConfig = {
...
export class HrTimeTracking16Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_16_config;
...
// engagement solution for hr
const hr_engagement_17_config: AdapterConfig = {
  id: 'hr_engagement_17',
  name: 'CatalystForce',
  category: 'hr',
  description: 'engagement solution for hr',
...
export class HrEngagement17Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_17_config;
...
// learning solution for hr
const hr_learning_18_config: AdapterConfig = {
  id: 'hr_learning_18',
  name: 'VaultPro',
  category: 'hr',
  description: 'learning solution for hr',
...
export class HrLearning18Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_18_config;
...
// workforce solution for hr
const hr_workforce_19_config: AdapterConfig = {
  id: 'hr_workforce_19',
...
export class HrWorkforce19Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_19_config;
...
// analytics solution for hr
const hr_analytics_20_config: AdapterConfig = {
  id: 'hr_analytics_20',
  name: 'LogicPro',
  category: 'hr',
  description: 'analytics solution for hr',
...
export class HrAnalytics20Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_20_config;
...
// recruiting solution for hr
const hr_recruiting_21_config: AdapterConfig = {
  id: 'hr_recruiting_21',
...
export class HrRecruiting21Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_21_config;
...
// onboarding solution for hr
const hr_onboarding_22_config: AdapterConfig = {
  id: 'hr_onboarding_22',
  name: 'CloudPoint',
  category: 'hr',
  description: 'onboarding solution for hr',
...
export class HrOnboarding22Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_22_config;
...
// performance solution for hr
const hr_performance_23_config: AdapterConfig = {
...
export class HrPerformance23Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_23_config;
...
// payroll solution for hr
const hr_payroll_24_config: AdapterConfig = {
  id: 'hr_payroll_24',
...
export class HrPayroll24Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_24_config;
...
// benefits solution for hr
const hr_benefits_25_config: AdapterConfig = {
  id: 'hr_benefits_25',
  name: 'WaveWorks',
  category: 'hr',
  description: 'benefits solution for hr',
...
export class HrBenefits25Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_25_config;
...
// time tracking solution for hr
const hr_time_tracking_26_config: AdapterConfig = {
...
export class HrTimeTracking26Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_26_config;
...
// engagement solution for hr
const hr_engagement_27_config: AdapterConfig = {
  id: 'hr_engagement_27',
  name: 'LogicPoint',
  category: 'hr',
  description: 'engagement solution for hr',
...
export class HrEngagement27Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_27_config;
...
// learning solution for hr
const hr_learning_28_config: AdapterConfig = {
  id: 'hr_learning_28',
  name: 'GridCore',
  category: 'hr',
  description: 'learning solution for hr',
...
export class HrLearning28Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_28_config;
...
// workforce solution for hr
const hr_workforce_29_config: AdapterConfig = {
  id: 'hr_workforce_29',
  name: 'VividLogic',
  category: 'hr',
  description: 'workforce solution for hr',
...
export class HrWorkforce29Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_29_config;
...
// PrismAI Adapter [409]
// analytics solution for hr
const hr_analytics_30_config: AdapterConfig = {
  id: 'hr_analytics_30',
  name: 'PrismAI',
  category: 'hr',
  description: 'analytics solution for hr',
...
export class HrAnalytics30Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_30_config;
...
// recruiting solution for hr
const hr_recruiting_31_config: AdapterConfig = {
  id: 'hr_recruiting_31',
  name: 'PulseWorks',
  category: 'hr',
  description: 'recruiting solution for hr',
...
export class HrRecruiting31Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_31_config;
...
// onboarding solution for hr
const hr_onboarding_32_config: AdapterConfig = {
  id: 'hr_onboarding_32',
  name: 'MatrixCloud',
  category: 'hr',
  description: 'onboarding solution for hr',
...
export class HrOnboarding32Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_32_config;
...
// performance solution for hr
const hr_performance_33_config: AdapterConfig = {
...
export class HrPerformance33Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_33_config;
...
// payroll solution for hr
const hr_payroll_34_config: AdapterConfig = {
  id: 'hr_payroll_34',
  name: 'TangentWave',
  category: 'hr',
  description: 'payroll solution for hr',
...
export class HrPayroll34Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_34_config;
...
// benefits solution for hr
const hr_benefits_35_config: AdapterConfig = {
  id: 'hr_benefits_35',
  name: 'BoltNetwork',
  category: 'hr',
  description: 'benefits solution for hr',
...
export class HrBenefits35Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_35_config;
...
// time tracking solution for hr
const hr_time_tracking_36_config: AdapterConfig = {
...
export class HrTimeTracking36Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_36_config;
...
// engagement solution for hr
const hr_engagement_37_config: AdapterConfig = {
  id: 'hr_engagement_37',
  name: 'Uplift360',
  category: 'hr',
  description: 'engagement solution for hr',
...
export class HrEngagement37Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_37_config;
...
// learning solution for hr
const hr_learning_38_config: AdapterConfig = {
  id: 'hr_learning_38',
  name: 'PixelBase',
  category: 'hr',
  description: 'learning solution for hr',
...
export class HrLearning38Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_38_config;
...
// workforce solution for hr
const hr_workforce_39_config: AdapterConfig = {
  id: 'hr_workforce_39',
  name: 'QuasarWave',
  category: 'hr',
  description: 'workforce solution for hr',
...
export class HrWorkforce39Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_39_config;
...
// analytics solution for hr
const hr_analytics_40_config: AdapterConfig = {
  id: 'hr_analytics_40',
...
export class HrAnalytics40Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_40_config;
...
// recruiting solution for hr
const hr_recruiting_41_config: AdapterConfig = {
  id: 'hr_recruiting_41',
  name: 'VividFlow',
  category: 'hr',
  description: 'recruiting solution for hr',
...
export class HrRecruiting41Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_41_config;
...
// onboarding solution for hr
const hr_onboarding_42_config: AdapterConfig = {
  id: 'hr_onboarding_42',
  name: 'RippleSoftware',
  category: 'hr',
  description: 'onboarding solution for hr',
...
export class HrOnboarding42Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_42_config;
...
// PeakPro Adapter [422]
// performance solution for hr
const hr_performance_43_config: AdapterConfig = {
...
export class HrPerformance43Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_43_config;
...
// payroll solution for hr
const hr_payroll_44_config: AdapterConfig = {
  id: 'hr_payroll_44',
  name: 'SphereZone',
  category: 'hr',
  description: 'payroll solution for hr',
...
export class HrPayroll44Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_44_config;
...
// benefits solution for hr
const hr_benefits_45_config: AdapterConfig = {
  id: 'hr_benefits_45',
  name: 'MeridianPro',
  category: 'hr',
  description: 'benefits solution for hr',
...
export class HrBenefits45Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_45_config;
...
// time tracking solution for hr
const hr_time_tracking_46_config: AdapterConfig = {
...
export class HrTimeTracking46Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_46_config;
...
// engagement solution for hr
const hr_engagement_47_config: AdapterConfig = {
  id: 'hr_engagement_47',
  name: 'LumenPlatform',
  category: 'hr',
  description: 'engagement solution for hr',
...
export class HrEngagement47Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_47_config;
...
// learning solution for hr
const hr_learning_48_config: AdapterConfig = {
  id: 'hr_learning_48',
  name: 'MatrixMind',
  category: 'hr',
  description: 'learning solution for hr',
...
export class HrLearning48Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_48_config;
...
// workforce solution for hr
const hr_workforce_49_config: AdapterConfig = {
  id: 'hr_workforce_49',
  name: 'LumenForce',
  category: 'hr',
  description: 'workforce solution for hr',
...
export class HrWorkforce49Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_49_config;
...
// analytics solution for hr
const hr_analytics_50_config: AdapterConfig = {
  id: 'hr_analytics_50',
  name: 'MeridianWorks',
  category: 'hr',
  description: 'analytics solution for hr',
...
export class HrAnalytics50Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_50_config;
...
// recruiting solution for hr
const hr_recruiting_51_config: AdapterConfig = {
  id: 'hr_recruiting_51',
  name: 'VectorMax',
  category: 'hr',
  description: 'recruiting solution for hr',
...
export class HrRecruiting51Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_recruiting_51_config;
...
// onboarding solution for hr
const hr_onboarding_52_config: AdapterConfig = {
  id: 'hr_onboarding_52',
  name: 'QuantumCloud',
  category: 'hr',
  description: 'onboarding solution for hr',
...
export class HrOnboarding52Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_onboarding_52_config;
...
// performance solution for hr
const hr_performance_53_config: AdapterConfig = {
...
export class HrPerformance53Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_performance_53_config;
...
// payroll solution for hr
const hr_payroll_54_config: AdapterConfig = {
  id: 'hr_payroll_54',
  name: 'EdgeWorks',
  category: 'hr',
  description: 'payroll solution for hr',
...
export class HrPayroll54Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_payroll_54_config;
...
// GlowAI Adapter [434]
// benefits solution for hr
const hr_benefits_55_config: AdapterConfig = {
  id: 'hr_benefits_55',
  name: 'GlowAI',
  category: 'hr',
  description: 'benefits solution for hr',
...
export class HrBenefits55Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_benefits_55_config;
...
// time tracking solution for hr
const hr_time_tracking_56_config: AdapterConfig = {
...
export class HrTimeTracking56Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_time_tracking_56_config;
...
// engagement solution for hr
const hr_engagement_57_config: AdapterConfig = {
  id: 'hr_engagement_57',
  name: 'TangentLogic',
  category: 'hr',
  description: 'engagement solution for hr',
...
export class HrEngagement57Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_engagement_57_config;
...
// learning solution for hr
const hr_learning_58_config: AdapterConfig = {
  id: 'hr_learning_58',
  name: 'BraveCore',
  category: 'hr',
  description: 'learning solution for hr',
...
export class HrLearning58Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_learning_58_config;
...
// workforce solution for hr
const hr_workforce_59_config: AdapterConfig = {
  id: 'hr_workforce_59',
  name: 'IonConnect',
  category: 'hr',
  description: 'workforce solution for hr',
...
export class HrWorkforce59Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_workforce_59_config;
...
// analytics solution for hr
const hr_analytics_60_config: AdapterConfig = {
  id: 'hr_analytics_60',
  name: 'VividDynamics',
  category: 'hr',
  description: 'analytics solution for hr',
...
export class HrAnalytics60Adapter extends GenericRestAdapter {
  readonly config: AdapterConfig = hr_analytics_60_config;
